...
cover_model.load_model("most_recent_actual_t1_cover_model.json")
...
wp_model.load_model("most_recent_t1_win_model.json")
...
over_model.load_model("most_recent_actual_over_model.json")
...
def playoff_page():
  ...
  with col3:
        ...
        #     st.markdown(f"""
        #         <div style="font-size:15px; font-weight:bold; color:{results_fr3.iloc[0]["losing_color"]}; text-align:center;">
        ...
        #     st.markdown(f"""
        #         <div style="font-size:15px; font-weight:bold; color:{results_fr4.iloc[0]["losing_color"]}; text-align:center;">
